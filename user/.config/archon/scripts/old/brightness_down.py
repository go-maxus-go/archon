...
if softBrightness > midSoftBrightness:
    newSoftBrightness = max(midSoftBrightness, softBrightness - softBrightnessDelta)
    ...
    newBrightness = max(minBrightness, brightness - brightnessDelta)
    ...
    newSoftBrightness = max(minSoftBrightness, softBrightness - softBrightnessDelta)
